...
int loadSettings() {
	...
	g_dipSwitch0 = cfg.dipSwitchJB0;
	g_dipSwitch1 = cfg.dipSwitchJB1;
	g_dipSwitch2 = cfg.dipSwitchJB2;
	g_dipSwitch3 = cfg.dipSwitchJB3;
...
void saveSettings() {
	...
	cfg.dipSwitchJB0 = g_dipSwitch0;
	cfg.dipSwitchJB1 = g_dipSwitch1;
	cfg.dipSwitchJB2 = g_dipSwitch2;
	cfg.dipSwitchJB3 = g_dipSwitch3;
