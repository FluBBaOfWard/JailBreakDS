...
#define EMUVERSION "V0.3.6 2021-09-14"
...
void uiAbout() {
	...
	drawText(" A:      Change weapon", 8, 0);

	drawText(" JailBreakDS  " EMUVERSION, 20, 0);
...
void uiLoadGame() {
	...
	drawMenuItem(" Jail Break");
	drawMenuItem(" Jail Break (bootleg)");
	drawMenuItem(" Manhattan 24 Bunsyo (Japan)");
}
